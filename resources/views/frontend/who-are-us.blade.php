    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="{{URL::asset('frontend/imgs/whats.png')}}imgs/logo.png" class="d-inline-block align-top" alt="">
            </a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="owl-carousel articles-carousel">
                    <div class="card">
                        <div class="photo">
                            <img src="{{URL::asset('frontend/imgs/p2.jpg')}}" class="card-img-top" alt="...">
